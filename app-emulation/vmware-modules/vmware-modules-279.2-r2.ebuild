...
src_prepare() {
	...
	kernel_is ge 3 15 0 && epatch "${FILESDIR}/${PV_MAJOR}-inode_patch.patch"
	kernel_is ge 3 15 0 && epatch "${FILESDIR}/${PV_MAJOR}-vmci.patch"
	kernel_is ge 3 15 0 && epatch "${FILESDIR}/${PV_MAJOR}-vsock.patch"
