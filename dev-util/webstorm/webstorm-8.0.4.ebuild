...
DESCRIPTION="Most Intelligent WebStorm IDE for develop on js html css, 8.0.4 version"
...
src_install() {
	...
	doicon "bin/${PN}.png"
	make_desktop_entry ${PN} "${PROGNAME}" "${PN}" "Development" "StartupWMClass=jetbrains-webstorm"
}
pkg_postinst() {
    elog "Run /usr/bin/${PN}"
}
